...
// problem 0
// dt = [0.924, 0.462, 0.231, 0.1155, 0.05775, 0.028875]
// ./ex9 -m ../data/periodic-square.mesh -p 0 -r 0 -dt 0.924 -tf 9 -vs 20 -s 22 -o 3

// problem 3
// dt = [2, 1, 0.5, 0.25, 0.125, 0.0625]
// ./ex9 -m ../data/periodic-square.mesh -p 3 -r 0 -dt 2 -tf 9 -vs 20 -s 22 -o 3
// ./ex9_advection -m ../data/star-mixed.mesh -p 0 -r 3 -o 2 -s 22
...
for (int i = 0; i < mesh.GetNE(); i++)
{
   ...
   const IntegrationRule* ir = &IntRules.Get(fes.GetFE(i)->GetGeomType(),
                                             2 * fes.GetFE(i)->GetOrder() + 1);
...
//////////////////////////////////////////////////// added by soha ////////////////////////////////////////////////////////////////
   ...
   int mesh_size = sqrt(rows) / 4;

   cout << "Mesh size is: (" << mesh_size << ")" << endl;

   ofstream writeK("K_ex9_N="+to_string(unknowns)+"_dt="+to_string(dt)+"_CFL="+to_string(CFL)+".txt");
   k.PrintMatlab(writeK);
   writeK.close();

   ofstream writeM("M_ex9_N="+to_string(unknowns)+"_dt="+to_string(dt)+"_CFL="+to_string(CFL)+".txt");
   ...
   {
      ofstream sol("u_ex9_N="+to_string(unknowns)+"_dt="+to_string(dt)+"_CFL="+to_string(CFL)+".txt");
   ...
   ofstream osol("ex9_final_"+to_string(unknowns)+".vtk");
   osol.precision(precision);
      ...
      case 1:
      {
         switch (dim)
         {
            ...
            case 3:
            {
               ...
               // return (erfc(w*(X(0)-cx-rx)) * erfc(-w*(X(0)-cx+rx))) / 4.0;
